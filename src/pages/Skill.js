          ...
          <div className={style.aboutInfo}>
            <div className={style.firstChild}>
              ...
              <p>
                ...
                learnt programming languages such as Java, C++, Python, Dart,
                C#, JavaScript and app frameworks like Flutter, React JS and
                React Native. I am more advanced in Web development (Frontend)
                and a bit at the backend. Recently learned Sass, Node js and
                React Native. Trying my best to achieve my goal as a software
                engineer. <br />
                <br />
